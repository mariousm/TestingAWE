...
describe("UnitTest CONFIGURATION", () => {
    ...
    it.only("jsonToString CORRECT", () => {

        // Comprobamos que si le pasamos un fichero nos desvuelve el contenido del JSON a string
        let ruta = path.join(__dirname, "materialIN", "aweconfig1.json");
        let content = config.jsonToString(ruta);
    ...
    it.only("getNameFileConfig CORRECT", () => {
    ...
    it.only("checkExistFile CORRECT", () => {
    ...
    it.only("checkAweconfig CORRECT", () => {
