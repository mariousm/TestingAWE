...
describe("UnitTest AUTOMATION", function () {
    it.only("walkDirSrc CORRECT", function () {
        ...
        var appElectron = path.join(__dirname, "materialIN", "appElectron");
        var appSpectron = path.join(__dirname, "materialOUT", "appSpectron");
        ...
        var content = fs.readFileSync(path.join(appSpectron, "src", "html1", "html1.awe.ts"), 'utf8');
        var expected = fs.readFileSync(path.join(__dirname, "materialOUT", "html1.awe.ts"), 'utf8');
    ...
    // });
    it.only("createDirectory CORRECT", function () {
        // Comprobamos que si le pasamos una ruta nos genera el directorio
        var ruta = path.join(__dirname, "materialOUT", "prueba", "createDirectory");
    ...
    // })
    it.only("createFile CORRECT", function () {
        // Comprobamos que si le pasamos los parámetros de forma correcta crea el fichero
        var file = "createFile1.html";
        var electronPath = path.join(__dirname, "materialIN", "appElectron", "src", "html1", "html1.html");
        var spectronPath = path.join(__dirname, "materialOUT", "appSpectron", "src", "html1");
    ...
    //     assert.equal(bool, false);
    // })
    it.only("checkSameRoot CORRECT", function () {
        // Comprobamos que si le pasamos los datos de forma correcta hace lo que tiene que hacer
        var appElectron = path.join(__dirname, "materialIN");
        var appSpectron = path.join(__dirname, "materialOUT");
        var bool = aut.checkSameRoot(appElectron, appSpectron);
        assert.equal(bool, true);
    });
    ...
    // })
    it.only("checkExistDirectory CORRECT", function () {
        // Comprobamos que hace lo que tiene que hacer cuando le pasamos el parámetro correcto
        var ruta = path.join(__dirname, "materialIN", "appElectron");
        var bool = aut.checkExistDirectory(ruta);
        assert.equal(bool, true);
    ...
    // })
    it.only("check CORRECT", function () {
        // Comprobamos que pasandole los parámetros de forma correcta funciona
        var appElectron = path.join(__dirname, "project", "appElectron");
        var appSpectron = path.join(__dirname, "project", "appSpectron");
        var bool = aut.check(appElectron, appSpectron);
        assert.equal(bool, true);
    });
    // it.only("check FAIL", () => {
    ...
    //     assert.equal(bool, false);
    // })
    it.only("pathUnixWindows CORRECT", function () {
        ...
        var ruta = "hola/adios/quetal/estas/muy/bien";
        var content = aut.pathUnixWindows(ruta);
        var expected = "hola\\adios\\quetal\\estas\\muy\\bien";
        assert.equal(content, expected);
    ...
    // })
    it.only("getHtmlElements CORRECT", function () {
        // Comprobamos que nos proporciona la información de forma correcta
        var elements = [];
        var realElements = aut.getHtmlElements();
        ...
        for (var _i = 0, names_1 = names; _i < names_1.length; _i++) { // Nombre de las clases
            ...
            elements.push(name_1[0].toUpperCase() + name_1.slice(1));
        }
